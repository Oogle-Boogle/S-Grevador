...
public class MiningEvent extends Event<Player> {
	...
	public void execute() {
		...
		regExperience = mineral.getExperience() * (Config.MINING_EXPERIENCE * attachment.prestige()) + mineral.getExperience() * (Config.MINING_EXPERIENCE * attachment.prestige()) / 10 * pieces;
