 ...
 */
	...
	public enum Stall {
		Crafting(new GameItem(995, Misc.random(250) + 1200), 1, 16, 20, 45000),
		Silk(new GameItem(995, Misc.random(550) + 1850), 20, 24, 20, 42500),
		Food(new GameItem(995, Misc.random(750) + 2500), 25, 30, 10, 42500),
		Fur(new GameItem(995, Misc.random(2000) + 3250), 35, 54, 10, 40000),
		General(new GameItem(995, Misc.random(1000) + 5000), 50, 65, 10, 40000),
		Spice(new GameItem(995, Misc.random(1150) + 6250), 65, 81, 10, 38000),
		Magic(new GameItem(995, Misc.random(1250) + 7500), 75, 100, 10, 38000),
		Scimitar(new GameItem(995, Misc.random(1500) + 10000), 90, 160, 10, 35000);
