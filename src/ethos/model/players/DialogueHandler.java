...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		switch (dialogue) {
			case 37430:
				sendNpcChat2("Would you like to buy 100x battlestaves?", "Total cost: 500,000gp.", 50, "Barrel");
				c.nextChat = 37433;
				break;
			case 37433:
				sendOption2("Yes", "No");
		...
		case 11929:
			sendNpcChat3("Hello " + c.playerName + " I am the OSRS GP Donation Manager.",
					"If you are interested in donating, contact Oogle.",
		...
		case 55864:
			sendNpcChat2("Welcome and enjoy Tojad!", "Feel free to ask for help in the Help cc.",
		...
		case 55865:
			...
			break;
		case 55866:
			sendNpcChat2("Welcome and enjoy Tojad!", "Feel free to ask for help in the Help cc.", c.talkingNpc,
					"Shayzien Guard");
			c.nextChat = 0;
			break;
		...
		case 5998:
			sendNpcChat3("Only <img=4>@red@Donators @bla@can access the Donator Zone.",
					"Interested in becoming an Tojad <img=4>@red@Donator@bla@?",
		...
		case 55872:
			...
			break;
		case 55873:
			sendNpcChat2("Hello, my name is Banky.", "I was hired by Tojad to be a travelling banker!", c.talkingNpc,
					"Banky The Banker");
			c.nextChat = 0;
			break;
		case 55875:
		...
		case 674:
			c.getPA().movePlayer(3079, 3491, 0);
		...
		case 676:
			c.getPA().movePlayer(3092, 3479, 0);
			sendNpcChat("Slayer masters are located here.", "Doing slayer early is a good way to start off.");
			c.nextChat = 677;
			break;

		case 677:
			c.getPA().movePlayer(3078, 3501, 0);
			sendNpcChat("Here you can use your starter keys", "You can also use your clue scrolls on watson",
					"He can exchange them for you", "Goodluck on your loot keys!");
			c.nextChat = 678;
			break;

		case 678:
			c.getPA().movePlayer(3087, 3512, 0);
			...
			case 679:
				c.getPA().movePlayer(3083, 3470, 0);
				sendNpcChat("Here you can change your magic spellbook.");
				c.nextChat = 680;
				break;
		case 680:
			...
			sendNpcChat("Finally you can start your adventure,", "type ::discord to recieve alerts when events happen.",
					"Also ::forums to keep up-to-date with Grevador, Enjoy!.");
			c.nextChat = 645;
			break;
