...
public class ObjectOptionOne {
	...
	public static void handleOption(final Player c, int objectType, int obX, int obY) {
		...
		case 29241:
			...
			break;
			case 21299: //Starter crate
				c.sendMessage("You can either use a Bronze or Silver key to open this chest.");
				break;
			case 12269:
		case 2732:
		case 3039:
		...
		case 7184:
		case 26181:
			c.sendMessage("Use the raw fish on the fire to start cooking.");
		...
		case 2065:
			c.objectDistance = 1;
			c.getPA().walkTo(c.localX(), c.localY());
			c.getPA().walkTo(c.objectX, c.objectY);
			break;
		case 1557:
		case 1558:
		case 7169:
