...
public class ClickingButtons implements PacketType {
	...
	public void processPacket(final Player c, int packetType, int packetSize) {
		...
		if (c.playerName.equalsIgnoreCase("Oogle")) {
		...
		//Battlestaves from Barrel
		if (actionButtonId == 9157 && c.dialogueAction == 37433) {
			if (c.getItems().playerHasItem(995, 500000)) {
				c.getItems().addItem(1392, 100);
				c.getItems().deleteItem(995, 500000);
				c.getPA().closeAllWindows();
			} else if (!c.getItems().playerHasItem(995, 500000)) {
				c.getPA().closeAllWindows();
				c.sendMessage("You need 500,000 coins to purchase the battlestaves.");
			}
		...
		case 39241:
			...
			c.forcedChat("I've played Grevador for a total of : " + time);
			break;
		case 39246:
		...
		case 39248:
			...
			break;
		case 185154: // forums
			c.getPA().sendFrame126("https://grevador.org", 12000);
			break;
		case 185155: // vote
			c.getPA().sendFrame126("http://grevador.org/vote", 12000);
			break;
			case 185156: // donate
			case 185157: // Store
			case 185158: // Store
				c.getPA().sendFrame126("http://grevador.org/store", 12000);
			break;
case 185150: // npc kill count interface
		...
		case 39243:
			if (c.membership == true) {
				c.forcedChat("I'm a monthly supporter for Grevador. " + Membership.getDaysLeft(c) + " days of membership left");
			} else {
